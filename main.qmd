...
- Sex: two curves are different, but relatively close together, and they overlap at the beginning and around 60 months. Overall, females seem to have a higher survival probability compared to male on average but we need more evidence.

- Smoking status: the three curves are relatively close together at the very beginning. Overall, people who never smoked seem to have a higher survival probability compared to people who are active smokers, or people who are former smokers. Active and former smokers seem to have relatively similar survival experience.

- Mutation count: it seems like survival probability increases as mutation count increases, though the survival distribution of quartile 1, 2, and 3 are relatively close together and hard to observe.

- Fraction of genome altered: it seems like the group with the lowest fraction of genome altered (quartile 1) experienced  higher survival probability. It seems like survival probability decreases as the fraction of genome altered increases. However, the other 3 groups (quartile 2, 3, 4), the survival distribution have relatively small differences and do across with each other.

- MSI score: it seems like the group with the lowest MSI score (quartile 1) experienced  higher survival probability. It seems like survival probability decreases as the MSI score increases. However, the other 3 groups (quartile 2, 3, 4), the survival distribution have relatively small differences especially at the beginning
